        ...
        <div>
           ...
           <form className="d-block w-75 mx-auto" onSubmit={onSubmitHandler}>
               <div className="d-flex justify-content-around sticky d-block w-75 mx-auto p-2">
                    ...
                    <input type="submit" className="btn btn-lg btn-success" value="Create" />
                </div>
               ...
               <div className="row my-1 w-75 mx-auto">
                   <div className="col">
                       <input type="number" name="minutes" onChange={onChangeHandler} className="form-control" placeholder="minutes" aria-label="minutes"/>
                   </div>
                    <div className="col">
